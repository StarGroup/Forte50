...
/* child theme override of admired_continue_reading_link()
*  Note: you must manually wrap the function in the parent theme with:
*  " if ( ! function_exists( 'admired_continue_reading_link' ) ) : "
*    existing function ....
*  " endif; "
*/
